...
class Muons:
	...
	def invarmasstest (self,m1,m2, Em1, Em2):
		return math.sqrt(m1**2+m2**2+2*(Em1*Em2-self.P1[1]*self.P2[1]-self.P1[2]*self.P2[2]-self.P1[3]*self.P2[3]))
	...
	def __str__(self,M1,M2,M3,Mtest):
		...
		rv="{0}{1}{2}{3}".format(M1, ' compared to invariant with mass in the calculations ', Mtest, '\n')
		return rv
...
class Particle:
	...
	def magofp (Px,Py,Pz):
		...
		return magP
	def Emtest(self):
		return pow(self.Pt**2+self.m**2,1/2)*math.cosh(self.eta)
...
if __name__=="__main__":
	...
	for line in lines[0::2]:
		...
		Mtest=p2p.invarmasstest(mphieta1[0],mphieta2[0], E1m, E2m)
		p2pstr=p2p.__str__(invM1,invM2,invM3,Mtest)
		print(p2pstr)
		a=a+1	
